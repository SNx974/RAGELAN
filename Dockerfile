...
# bcryptjs est intégré au bundle : Next l'inline dans ses propres chunks
# serveur, il n'est donc pas résolvable depuis /app/node_modules.
# Seul @prisma/client reste externe (il doit charger son moteur natif).
...
# Prisma reste externe aux bundles seed/status : ses deux paquets doivent
# donc exister réellement dans node_modules. Copiés après standalone pour
# ne pas être écrasés, et sans dépendre du tracing de Next.
