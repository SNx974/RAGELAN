              ...
              {r.status === 'PENDING' && (
                <div className="flex gap-2">
                  <button
                    ...
                    disabled={busy === r.id}
                    className="flex h-10 items-center gap-1.5 rounded-lg border border-rage-red/40 px-3 text-xs font-semibold text-rage-red hover:bg-rage-red/10"
                  >
                    <X className="size-4" />
                    Refuser
                  </button>
                  <button
                    ...
                    disabled={busy === r.id}
                    className="flex h-10 items-center gap-1.5 rounded-lg bg-rage-gradient px-4 text-xs font-bold text-black shadow-neon hover:brightness-110"
                  >
